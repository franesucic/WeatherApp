...
function Zagreb() {
    ...
    const handleWholeYear = async (e) => {
        let response = await fetch('http://localhost:3000/all/Zagreb');
    ...
    const handleFirstHalf = async (e) => {
        let response = await fetch('http://localhost:3000/firstSix/Zagreb');
        let jsonData = await response.json();
        setUserData({
    ...
    const handleSecondHalf = async (e) => {
        let response = await fetch('http://localhost:3000/lastSix/Zagreb');
        let jsonData = await response.json();
        setUserData({
