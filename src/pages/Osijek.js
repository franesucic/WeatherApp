...
function Osijek() {
    ...
    const handleWholeYear = async (e) => {
        let response = await fetch('http://localhost:3000/all/Osijek');
    ...
    const handleFirstHalf = async (e) => {
        let response = await fetch('http://localhost:3000/firstSix/Osijek');
        let jsonData = await response.json();
        setUserData({
    ...
    const handleSecondHalf = async (e) => {
        let response = await fetch('http://localhost:3000/lastSix/Osijek');
        let jsonData = await response.json();
        setUserData({
