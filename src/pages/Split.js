...
function Split() {
    ...
    const handleWholeYear = async (e) => {
        let response = await fetch('http://localhost:3000/all/Split');
    ...
    const handleFirstHalf = async (e) => {
        let response = await fetch('http://localhost:3000/firstSix/Split');
        let jsonData = await response.json();
        setUserData({
    ...
    const handleSecondHalf = async (e) => {
        let response = await fetch('http://localhost:3000/lastSix/Split');
        let jsonData = await response.json();
        setUserData({
